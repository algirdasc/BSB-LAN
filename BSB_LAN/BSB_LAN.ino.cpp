...
void setup();
#line 925 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void interruptHandlerTWWPush() {
...
# 1139 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
uint_farptr_t calc_enum_offset(uint_farptr_t enum_addr, uint16_t enumstr_len, int shift) {
  return enum_addr;
}
...
# 1174 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
int dayofweek(uint8_t day, uint8_t month, uint16_t year)
{
...
# 1207 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void listEnumValues(uint_farptr_t enumstr, uint16_t enumstr_len, const char *prefix, const char *delimiter, const char *alt_delimiter, const char *suffix, const char *string_delimiter, uint16_t value, uint8_t print_mode, bool canBeDisabled) {
  uint16_t val = 0;
  uint16_t c=0;
  uint8_t bitmask=0;
...
# 1304 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
uint8_t recognizeVirtualFunctionGroup(float nr) {
  ...
  else if (nr >= BSP_TEMP && nr < BSP_TEMP + numCustomTemps) {return 10;}
  #if defined(BLE_SENSORS) && defined(ESP32)
...
# 1347 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
int findLine(float line
           , uint16_t start_idx
           , uint32_t *cmd)
{
...
# 1557 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void SerialPrintHex(byte val) {
  printFmtToDebug(PSTR("%02X"), val);
}
# 1575 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void SerialPrintHex32(uint32_t val) {
  printFmtToDebug(PSTR("%08lX"), val);
}
# 1594 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void SerialPrintData(byte* msg) {
...
# 1630 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void SerialPrintRAW(byte* msg, byte len) {
...
# 1698 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void loadPrognrElementsFromTable(float nr, int i) {
...
# 1793 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
...
# 1835 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void SerialPrintAddr(byte addr) {
  char device[5];
  printToDebug(TranslateAddr(addr, device));
}
# 1856 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
int bin2hex(char *toBuffer, byte *fromAddr, int len, char delimiter){
  int resultLen = 0;
...
# 1885 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
...
# 1926 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void SerialPrintType(byte type) {
  char device[5];
  printToDebug(TranslateType(type, device));
}
# 1943 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void prepareToPrintHumanReadableTelegram(byte *msg, byte data_len, int shift) {
  SerialPrintData(msg);
...
# 1965 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
int undefinedValueToBuffer(char *p) {
...
# 1988 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void printyesno(bool i) {
  if (i) {
...
# 2009 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
...
# 2029 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void remove_char(char* str, char c) {
  char *pr = str, *pw = str;
  while (*pr) {
    *pw = *pr++;
...
# 2064 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
#ifdef MAX_CUL
...
# 2201 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
...
#endif
# 3309 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
#ifdef LOGGER
void LogTelegram(byte* msg) {
...
# 3479 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
int set(float line
      , const char *val
      , bool setcmd)
{
...
# 4576 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void query(float line) {
  byte msg[33] = { 0 };
  byte tx_msg[33] = { 0 };
  uint32_t c;
...
# 4705 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void query(float line_start
          , float line_end
          , bool no_print)
{
...
# 4753 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void SetDevId() {
...
# 4787 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
  printFmtToDebug(PSTR("Device family: %d\r\nDevice variant: %d\r\n"), my_dev_fam, my_dev_var);
}
# 4803 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void SetDateTime() {
  byte rx_msg[33];
  byte tx_msg[33];
  uint32_t c;
...
#endif
# 4855 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
uint16_t setPPS(uint8_t pps_index, int16_t value) {
...
#if defined LOGGER || defined WEBSERVER
# 4883 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void transmitFile(File dataFile) {
...
#endif
# 4922 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void resetBoard() {
#ifdef MQTT
  mqtt_disconnect();
#endif
...
# 5135 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void loop() {
  byte msg[33] = { 0 };
  byte tx_msg[33] = { 0 };
  char c = '\0';
...
# 5627 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
        if ( p[1]=='S'
          || p[1]=='I')
        {
          float line;
...
# 5890 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
...
void dateTime(uint16_t* date, uint16_t* time) {
  ...
  *time = FS_TIME(hour(), minute(), second());
  ...
  #endif
#endif
# 7853 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
void setup() {
#ifdef BtSerial
  ...
  telnetServer->begin();
# 8478 "/home/algirdas/SynologyDrive/Development/Projektai/BSB-LAN/BSB_LAN/BSB_LAN.ino"
#ifdef AVERAGES
  resetAverageCalculation();
#endif
